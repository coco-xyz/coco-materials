...
> **说明：** Zalo 个人版通过二维码扫描使用你的真实 Zalo 账号连接——无需注册 Bot、无需 API 密钥、无需开发者账号。它通过 [zca-js](https://github.com/nicenathapong/zca-js)（逆向工程协议库）实现连接。
...
2. 连接已通过你的个人 Zalo 账号建立

### 第4步：开始聊天

1. 任何给你 Zalo 账号发送消息的人都会收到 AI 自动回复
2. 部署完成！
