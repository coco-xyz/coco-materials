# Use Case #085: AI Tax Preparation Assistant

**Operations | Industry: Finance, Enterprise | Task: Tax Preparation, Automation**
...
Teams using COCO's AI Tax Preparation Assistant report:
