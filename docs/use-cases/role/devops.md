...
## 3. AI Software Incident Postmortem Analyzer
...
5. Flag any CVEs with known active exploits in the wild
```

**Prompt 2: Base Image Upgrade Path Analysis**
```
...
5. A revised Dockerfile snippet implementing your recommendation
```

**Prompt 3: Blast Radius Assessment for a New CVE**
```
...
5. Prioritize the 3 highest-ROI fixes I should tackle first
```

**Prompt 2: Flaky Test Audit**
```
...
5. Estimate reliability improvement after implementing your recommendations
```

**Prompt 3: Pre-Merge Risk Assessment**
```
...
5. Draft an incident update for stakeholders
```

**Prompt 2: Traffic Policy Configuration Review**
```
...
5. Missing or incorrect traffic mirroring configurations
```

**Prompt 3: Pre-Event Capacity and Mesh Readiness Review**
```
...
5. Draft an incident update suitable for clinical leadership and IT management
```

**Prompt 2: Alert Rule Audit and Noise Reduction**
```
...
5. Expected alert volume reduction after implementing recommendations
```

**Prompt 3: HIPAA Access Log Anomaly Review**
```
...
5. Recommend whether each item should be reverted or codified into IaC
```

**Prompt 2: Security Group Drift Security Review**
```
...
5. Draft a security incident report if any items meet breach notification thresholds
```

**Prompt 3: Post-Incident Drift Root Cause Investigation**
```
...
5. A prioritized remediation list ordered by regulatory examination risk
```

**Prompt 2: Infrastructure Change DR Impact Assessment**
```
...
5. List DR documentation updates required before the change is approved for production
```

**Prompt 3: Tabletop Exercise Scenario Design**
```
...
5. Recommend quick-win automations to improve compliance in the next 30 days
```

**Prompt 2: Tag Value Inference for Untagged Resources**
```
...
5. Estimate what percentage of the compliance gap this bulk remediation will close
```

**Prompt 3: Tag Policy Design for Multi-Team Organization**
```
...
5. Draft a proactive customer communication for the highest-risk account
```

**Prompt 2: Alert Noise Reduction Analysis**
```
...
5. Estimate the alert volume reduction achievable from implementing your recommendations
```

**Prompt 3: SLA Breach Post-Mortem and Customer Communication**
```
...
5. Create a 90-day secrets hygiene improvement roadmap
```

**Prompt 2: Rotation Runbook Generation**
```
...
5. Post-rotation cleanup steps removing the old credential
```

**Prompt 3: Vault Policy Least-Privilege Audit**
```
...
5. Assess migration complexity and risk as a counterweight to the cost savings
```

**Prompt 2: Spot Instance Fleet Optimization**
```
...
5. Expected savings and availability improvement vs. current configuration
```

**Prompt 3: Reserved Instance and Savings Plan Portfolio Review**
```
...
5. If recommending hold or rollback, identify what specifically to investigate
```

**Prompt 2: Customer Segment Canary Impact Analysis**
```
...
5. Recommend whether the rollout can proceed safely for all segments or requires a targeted rollback
```

**Prompt 3: Rollback Decision Analysis**
```
...
5. Cost estimate for maintaining sufficient capacity through the entire term
```

**Prompt 2: Auto-Scaling Configuration Audit and Optimization**
```
...
5. Provide revised configuration with specific values and the reasoning behind each change
```

**Prompt 3: Live Event Infrastructure Planning**
```
