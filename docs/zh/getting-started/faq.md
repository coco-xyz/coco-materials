...
::: details Q5：Agent 停止服务后，COCO 是否还保留我的凭证？

**我们的承诺**

- 服务终止后，COCO 承诺将及时删除所保存的凭证（SSH Key、API Token 等）
...
::: details Q9：COCO 和普通 ChatGPT 有什么区别？
...
::: details Q11：COCO 支持哪些 AI 模型？

COCO 是**全托管服务**，底层 AI 模型由我们统一管理，你无需自备 API Key：

| 套餐 | 使用模型 | 能力说明 |
|------|---------|---------|
| **Air** | 主流大模型标准版 | 日常任务：写作、整理、分析 |
| **Pro / Ultra** | 顶级推理模型 | 复杂推理、超长文档、高频使用 |

**模型切换**：COCO 会根据任务类型和成本效率自动选择最适合的模型，对用户无感知。我们持续评估和接入市场上最优秀的模型，确保你始终使用最佳方案。遇到特殊需求（如 Enterprise 合规要求指定模型）可联系我们单独协商。
