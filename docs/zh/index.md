...
features:
  ...
  - icon: 💬
    title: "在你常用的工具里工作"
    details: "Telegram、飞书、WhatsApp、Microsoft Teams、Zalo 等。不用装新应用，像给同事发消息一样指挥你的 AI 员工。"
    link: /zh/channels/
    linkText: 查看渠道
  - icon: 🎯
    title: "30 个角色 × 19 个行业"
...
<div class="step-desc">将 COCO 添加到 Telegram、飞书、WhatsApp、Microsoft Teams 或 Zalo。2 分钟完成，无需 API Key，无需技术配置。</div>
</div>
<div class="step-card">
...
<!-- Commented out: Zalo 个人版卡片从首页移除（设置流程已改为 AI 员工引导，不再通过 Dashboard）
<a href="./getting-started/channel-deployment#zalo-personal" class="channel-card">
<div class="channel-icon">💙</div>
<div class="channel-name">Zalo 个人版</div>
</a>
-->
