...
features:
  ...
  - icon: 💬
    title: "在你常用的工具里工作"
    details: "Telegram、飞书、WhatsApp、Microsoft Teams、Zalo (官方) 等。不用装新应用，像给同事发消息一样指挥你的 AI 员工。"
    link: /zh/channels/
    linkText: 查看渠道
  - icon: 🎯
    title: "30 个角色 × 19 个行业"
...
<a href="./channels/discord" class="channel-card">
<div class="channel-icon">🎮</div>
<div class="channel-name">Discord</div>
</a>
<!-- Commented out: Zalo 个人版（非官方） 卡片从首页移除（设置流程已改为 AI 员工引导，不再通过 Dashboard）
<a href="./getting-started/channel-deployment#zalo-personal" class="channel-card">
<div class="channel-icon">💙</div>
<div class="channel-name">Zalo 个人版（非官方）</div>
</a>
-->
