...
5. 设置 **Messaging endpoint** 为你的 AI 员工的 MS Teams webhook URL，格式为：
   ```
...
> **注意：** Messaging endpoint 是必填项。没有它，Azure Bot Service 无法将 Teams 消息转发给你的 AI 员工。
