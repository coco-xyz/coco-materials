...
本隐私政策描述了 **COCO Labs Limited**（以下简称"COCO"、"我们"或"本公司"）在您使用 COCO AI 数字员工平台 **icoco.ai**、相关服务及面向客户的渠道（统称"平台"）时，如何收集、使用、共享和保护个人信息。
...
- 消息通过 HXA-Connect 枢纽（connect.icoco.ai）经加密 WebSocket 连接路由
- 通信范围限定在您组织内经授权的代理之间
...
如需行使这些权利，请通过 **service@icoco.ai** 联系我们。我们将在 15 个工作日内回复。
...
如果我们发现已收集到儿童的数据，我们将立即删除并采取措施防止进一步收集。如果您认为有儿童提供了个人数据，请通过 **service@icoco.ai** 联系我们。
