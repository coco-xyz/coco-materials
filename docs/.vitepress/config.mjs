          ...
          '/channels/': [
            {
              ...
              items: [
                ...
                { text: 'Microsoft Teams', link: '/getting-started/channel-deployment#ms-teams' },
          ...
          '/zh/channels/': [
            {
              ...
              items: [
                ...
                { text: 'Microsoft Teams', link: '/zh/getting-started/channel-deployment#ms-teams' },
                { text: 'Zalo', link: '/zh/getting-started/channel-deployment#zalo' },
                { text: 'Zalo Personal', link: '/zh/getting-started/channel-deployment#zalo-personal' },
