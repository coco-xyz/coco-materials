...
在 App Registration 页面，进入 **API permissions** → **Add a permission** → **Microsoft Graph** → **Application permissions**。
...
全部添加后，点击 **Grant admin consent for [你的组织]** 并确认。所有权限应显示绿色勾号。

> **注意：** 必须获得管理员同意。否则文件下载、聊天历史和智能模式功能将无法使用。
