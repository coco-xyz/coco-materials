...
|-----------|----------|-----------|
| [Writing & Content](./task/writing-content) | Documents, copy, reports, emails | SEO Writer, API Docs, Proposals, JDs, Newsletter |
| [Data Analysis](./task/data-analysis) | Reports, metrics, insights | Financial Reports, Competitive Analysis, User Analytics |
| [Process Automation](./task/process-automation) | Workflows, approvals, routing | Ticket Classification, Expense Auditing, CRM Updates, Invoice Processing |
| [Research & Monitoring](./task/research-monitoring) | Competitive intel, lead research, monitoring | Competitive Copywriter, Lead Researcher, Deploy Monitor |

## Browse by Industry

| Industry | Key Scenarios |
|----------|--------------|
| [Technology / SaaS](./industry/technology) | Code Review, Deploy Monitor, API Docs, Debug Assistant |
| [E-commerce / Retail](./industry/ecommerce) | Inventory Forecasting, Social Media, Customer Support |
| [Financial Services](./industry/financial-services) | Expense Auditing, Financial Reports, Compliance |
