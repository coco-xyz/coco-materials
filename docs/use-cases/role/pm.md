...
1. **Value Metric Analysis and Selection**: Identifies the pricing unit that most accurately tracks how customers experience and quantify the value your product delivers.
...
2. **Packaging Architecture Design**: Structures feature tiers that align to distinct buyer segment needs rather than reflecting internal development history.
...
3. **Competitive Pricing Landscape Analysis**: Maps your pricing against the competitive landscape to identify positioning opportunities and vulnerability.
...
4. **Pricing Scenario Modeling**: Tests the revenue and growth implications of different pricing strategies before committing.
...
5. **Buyer Psychology and Willingness-to-Pay Framing**: Structures the pricing presentation to align with how different buyers evaluate price-value fit.
...
6. **Stakeholder Pricing Rationale Package**: Generates the documentation needed to get pricing decisions approved by sales, finance, and executive leadership.
...
Recommend the best value metric and explain what changes it would require to my current pricing structure.
```

**Prompt 2: Design a Packaging Architecture for Different Buyer Segments**
```
...
6. The packaging "story": how to explain the tier structure to a buyer in one clear sentence per tier
```

**Prompt 3: Analyze Competitive Pricing and Find Positioning Opportunities**
```
...
6. Recommend a competitive pricing response: how should I position my pricing in sales conversations against each competitor?
```

**Prompt 4: Model the Revenue Impact of a Pricing Change**
```
...
7. What is the recommended implementation approach to minimize churn risk while capturing upside?
```

**Prompt 5: Build a Pricing Rationale Document for Leadership and Sales**
```
...
<video controls style="width: 100%; max-width: 480px; max-height: 400px; border-radius: 8px; margin: 0.5rem 0 1rem;">
  <source src="/videos/en/423-ai-pm-sprint-planning-optimizer.mp4" type="video/mp4">
</video>
...
<video controls style="width: 100%; max-width: 480px; max-height: 400px; border-radius: 8px; margin: 0.5rem 0 1rem;">
  <source src="/videos/en/455-ai-pm-product-roadmap-prioritization-engine.mp4" type="video/mp4">
</video>
...
<video controls style="width: 100%; max-width: 480px; max-height: 400px; border-radius: 8px; margin: 0.5rem 0 1rem;">
  <source src="/videos/en/503-ai-pm-user-story-refinement-engine.mp4" type="video/mp4">
</video>
...
<video controls style="width: 100%; max-width: 480px; max-height: 400px; border-radius: 8px; margin: 0.5rem 0 1rem;">
  <source src="/videos/en/539-ai-pm-customer-feedback-synthesizer.mp4" type="video/mp4">
</video>
...
<video controls style="width: 100%; max-width: 480px; max-height: 400px; border-radius: 8px; margin: 0.5rem 0 1rem;">
  <source src="/videos/en/557-ai-pm-feature-adoption-tracking-advisor.mp4" type="video/mp4">
</video>
...
<video controls style="width: 100%; max-width: 480px; max-height: 400px; border-radius: 8px; margin: 0.5rem 0 1rem;">
  <source src="/videos/en/577-ai-pm-release-readiness-checklist-builder.mp4" type="video/mp4">
</video>
