...
features:
  ...
  - icon: 📋
    ...
    details: 1,001 real-world scenarios across 18 roles and 26 industries. From code review to financial reports — each with detailed solutions and practical prompts.
    link: /use-cases/
  - icon: 🎬
    title: Social Media
