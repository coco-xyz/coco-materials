...
> 从已完成的项目交付物中提取可复用的方法论、框架和洞察——构建加速未来项目交付的机构知识。

::: details 痛点与 COCO 解决方案

**痛点：咨询公司不断重复解决相同的问题，却未能沉淀所学**

专业服务公司在每个项目中都倾注了大量智力努力——开发框架、验证假设、综合研究、构建工具。然而这些智力资产绝大多数都锁在各个项目文件夹中，只有参与该具体项目的成员才能访问。当新项目出现类似问题时，团队基本上又从头开始，重新开发方法并错过应用前期工作洞察的机会。

**COCO 的解决方案**

1. **交付物分析与洞察提取**：COCO 处理已完成项目的交付物，提取可复用的方法论要素、框架和分析方法。
2. **案例研究生成**：COCO 从项目数据中起草匿名化案例研究摘要，适用于业务拓展和知识分享。
3. **框架文档化**：COCO 将各项目的临时分析方法转化为有文档记录、可复用的框架，附带应用指南。
4. **知识缺口分析**：COCO 对照当前客户需求模式审计公司现有知识库，识别专业知识沉淀中的空白。
5. **提案内容挖掘**：COCO 在现有交付物中搜索可用于新提案的内容，节省研究和起草时间。

:::

::: details 预期成果与影响

- **项目启动时间**：拥有 AI 整理知识库的团队，项目启动研究时间减少 **40–60%**
- **提案赢单率**：包含前期项目证据的提案转化率 **比通用能力陈述高 25–35%**
- **知识沉淀率**：AI 辅助提取的沉淀率 **达 70–80%**（vs. 人工记录不足 **20%**）
- **重复工作减少**：触手可及的前期工作资料使同类项目的重复分析工作减少 **30–45%**
- **新顾问生产力**：访问有序的前期工作资料使初级顾问的贡献时间 **缩短 30–40%**
...
**提示词 1：项目知识提取**
```
请从以下已完成的项目交付物中提取可复用的知识和洞察。

项目类型：[战略/实施/评估/顾问]
行业：[客户行业]
项目摘要：[简要描述完成了什么工作，发现了什么]
交付物类型：[评估报告/战略材料/实施手册/分析/工作坊成果]

交付物内容：[粘贴交付物或关键章节——请对客户特定信息进行匿名化处理]

提取：
1. 可复用的分析框架或方法论（描述可应用于其他项目的方法）
2. 超越该客户的关键洞察（已识别的行业趋势、常见模式、最佳实践）
3. 开发的可复用工具或模板（评估工具、评分框架、模板）
4. 经验教训：哪些做法有效，哪些应有所改进
5. 案例研究摘要草稿（3段，完全匿名，重点突出挑战、方法和成果）
6. 知识库标签：行业、项目类型、问题类型、使用的方法论
```

**提示词 2：提案内容搜索与汇编**
```
请为以下新提案搜索并汇编相关的前期工作资料。

新项目类型：[描述]
客户行业：[描述]
客户挑战：[描述新客户希望解决的问题]
提案所需证明材料：[列出提案需要展示的内容]

现有知识库摘要：[描述或粘贴现有项目摘要、案例研究和框架]

汇编：
1. 最相关的前期项目引用（附建议引用角度）
2. 应在方法论章节重点介绍的前期工作框架
3. 可作为证明材料的前期量化成果
4. 现有证据的空白（需要一次性研究或在提案中另作处理的部分）
5. 基于现有材料，建议的经验资质章节叙事结构
```
