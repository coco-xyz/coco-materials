...
- **样本规模可扩展性**：COCO 使研究者能够在项目时间线内对30至100份以上的访谈记录进行系统性分析，而传统方法在保持完整严谨性的前提下通常只能容纳8至15份
